...
1. Download `fess-llm-openai-15.7.0.jar`
...
- ``FESS_PLUGINS=fess-llm-openai:15.7.0`` makes the container's ``run.sh`` download and install the plugin into ``app/WEB-INF/plugin/`` automatically
