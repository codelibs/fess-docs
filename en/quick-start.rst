...
see the :doc:`Docker Installation Guide <15.8/install/install-docker>`.
...
- :doc:`Admin Guide <15.8/admin/index>` - Configuration and management
- :doc:`API Reference <15.8/api/index>` - Integrate search into your applications
