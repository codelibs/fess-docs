...
1. Download `fess-llm-gemini-15.9.0.jar`
...
- ``FESS_PLUGINS=fess-llm-gemini:15.9.0`` makes ``run.sh`` automatically download and install the plugin JAR into ``app/WEB-INF/plugin/``
