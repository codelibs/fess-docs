...
1. Download `fess-llm-ollama-15.9.0.jar`.
...
- ``FESS_PLUGINS=fess-llm-ollama:15.9.0`` causes the startup script to automatically download the plugin JAR and place it in ``app/WEB-INF/plugin/`` (adjust the version to match your |Fess| version)
