...
The Chat API is a RESTful API for programmatic access to |Fess|'s AI mode functionality.
...
1. AI mode functionality must be enabled (``rag.chat.enabled=true``)
...
- :doc:`../config/rag-chat` - AI Mode Configuration
