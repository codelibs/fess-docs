...
.. note::
   The ``OPENSEARCH_HEAP_SIZE`` environment variable is deprecated in OpenSearch 3.x and later. Use ``config/jvm.options`` or the ``OPENSEARCH_JAVA_OPTS`` environment variable instead.
