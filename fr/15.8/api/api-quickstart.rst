...
.. code-block:: json

    {
      "response": {
        ...
        "data": [
          {
            "title": "Fess - Serveur de recherche d'entreprise Open Source",
            "url": "https://fess.codelibs.org/ja/",
            "content_description": "<strong>Fess</strong> est facile à déployer...",
...
.. code-block:: python
    ...
    def search(query, num=20, start=0):
        """Appelle l'API de recherche Fess"""
        params = {
            "q": query,
            "num": num,
            "start": start
    ...
    results = search("Fess recherche")
    print(f"Nombre de résultats : {results['response']['record_count']}")
...
.. code-block:: javascript
    ...
    // Exemple d'utilisation
    search('Fess recherche').then(results => {
      console.log(`Nombre de résultats : ${results.response.record_count}`);
...
.. code-block:: java
    ...
    public class FessApiClient {
        ...
        public static void main(String[] args) throws Exception {
            ...
            String result = client.search("Fess recherche");
...
.. note::
   ...
   Dans |Fess| 15.8, l'ancienne API de recherche JSON ``/api/v1`` et l'API de chat ont été supprimées.
