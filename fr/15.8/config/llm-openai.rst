...
1. Telechargez `fess-llm-openai-15.8.0.jar`
...
- ``FESS_PLUGINS=fess-llm-openai:15.8.0`` fait que ``run.sh`` du conteneur telecharge et installe automatiquement le plugin dans ``app/WEB-INF/plugin/``
