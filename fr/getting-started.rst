...
.. warning::
   ...
   **Note importante concernant la sécurité**
   ...
   Pour les instructions de changement de mot de passe, consultez :doc:`15.8/admin/user-guide`.
...
- :doc:`15.8/admin/index` — Détails sur la configuration de l'exploration et de la recherche
- :doc:`15.8/api/index` — Intégration de la recherche via l'API REST
