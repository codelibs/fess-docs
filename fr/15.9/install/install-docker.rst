...
::
    ...
    $ git clone --depth 1 --branch v15.9.0 https://github.com/codelibs/docker-fess.git
...
Depuis |Fess| 15.9, la fonctionnalité de mode de recherche IA (RAG Chat) a été séparée sous forme de plugins ``fess-llm-*``.
...
2. Récupérez le modèle du fichier de configuration (uniquement la première fois) ::
       ...
       $ curl -o /path/to/fess-config/fess_config.properties https://raw.githubusercontent.com/codelibs/fess/refs/tags/fess-15.9.0/src/main/resources/fess_config.properties
