=====================================================
Recherche par champ (limiter au titre, à l'URL, etc.)
=====================================================
...
::
   ...
   url:https\:\/\/fess.codelibs.org\/ja\/15.9\/*
   url:"https://fess.codelibs.org/ja/15.9/*"
...
.. tip::
    Si vous souhaitez rechercher une partie de l'URL, vous pouvez utiliser ``inurl:`` pour effectuer une recherche par correspondance partielle sur l'URL. Par exemple, ``inurl:15.9`` recherche les documents dont l'URL contient ``15.9``.
