...
1. Téléchargez `fess-llm-openai-15.9.0.jar`
...
- ``FESS_PLUGINS=fess-llm-openai:15.9.0`` fait que ``run.sh`` du conteneur télécharge et installe automatiquement le plugin dans ``app/WEB-INF/plugin/``
