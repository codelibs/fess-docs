...
Pour une installation manuelle, placez le fichier JAR correspondant (par exemple ``fess-llm-openai-15.9.0.jar`` pour le fournisseur OpenAI) dans le répertoire suivant.
