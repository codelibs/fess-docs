...
1. Téléchargez `fess-llm-gemini-15.9.0.jar`
...
- ``FESS_PLUGINS=fess-llm-gemini:15.9.0`` fait que ``run.sh`` télécharge automatiquement le plugin JAR et le place dans ``app/WEB-INF/plugin/``
