...
1. Téléchargez `fess-llm-ollama-15.9.0.jar`.
...
- ``FESS_PLUGINS=fess-llm-ollama:15.9.0`` permet au script de démarrage de récupérer automatiquement le JAR du plugin et de le placer dans ``app/WEB-INF/plugin/`` (adaptez la version à votre installation de |Fess|)
