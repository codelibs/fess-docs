...
.. note::
   ...
   应写为 ``C:/opensearch-3.3.0/data/config/`` 而不是 ``C:\opensearch-3.3.0\data\config\``。
...
1. 从 `下载站点 <https://fess.codelibs.org/ja/downloads.html>`__ 下载 Windows 用的 ZIP 包。
...
例::
    ...
    C:\opensearch  (推荐)
    C:\Program Files\opensearch-3.3.0  (不推荐 - 路径过长)
