...
1. 创建一个以虚拟主机键的小写形式命名的静态主题，例如 ``tenant1``
   （参见 :ref:`theme-customize-bundled` ）
2. 在「系统」→「主题」中安装该主题

之后，对该虚拟主机的请求将使用该主题。详情请参见 :doc:`security-virtual-host` 。

自定义CSS
---------

要为每个虚拟主机应用自定义CSS，请修改该虚拟主机所用主题中的 ``assets/styles.css`` 。
