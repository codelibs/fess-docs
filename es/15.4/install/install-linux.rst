...
- Java 21 instalado
- OpenSearch 3.4.0 disponible (o nueva instalación)
...
1. Descarga de OpenSearch
   ...
   .. note::
      ...
      En este ejemplo se utiliza OpenSearch 3.4.0.
...
2. Instalación de plugins de OpenSearch
   ...
   .. important::
      ...
      En el ejemplo anterior, se especifica 3.4.0 para todos.
...
Se recomienda encarecidamente usar la versión recomendada (3.4.0) para garantizar la compatibilidad de los plugins.
