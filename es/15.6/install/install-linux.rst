...
1. Descarga de OpenSearch
   ...
   .. note::
      ...
      En este ejemplo se utiliza OpenSearch 3.6.0.
...
Se recomienda encarecidamente usar la versión recomendada (3.6.0) para garantizar la compatibilidad de los plugins.
