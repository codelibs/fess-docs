...
Ejecute la clase ``org.codelibs.fess.FessBoot`` en su IDE y verifique el funcionamiento.
...
- `Foro de Fess (EN) <https://discuss.codelibs.org/c/FessEN/>`__
- `Foro de Fess (JA) <https://discuss.codelibs.org/c/FessJA/>`__
