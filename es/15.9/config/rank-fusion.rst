...
En |Fess| 15.9, la búsqueda semántica (chunking de contenido + búsqueda vectorial) se proporciona
...
.. warning::
   ...
   ``semantic_chunk``, introducido en la 15.9. Si traslada esa configuración de la era 15.7 a la
   15.9 sin cambios, la lista de permitidos nunca incluye ``semantic_chunk``, por lo que la
