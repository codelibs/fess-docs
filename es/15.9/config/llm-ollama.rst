...
1. Descargue `fess-llm-ollama-15.9.0.jar`.
...
- ``FESS_PLUGINS=fess-llm-ollama:15.9.0`` hace que el script de inicio obtenga automáticamente el JAR del plugin y lo coloque en ``app/WEB-INF/plugin/`` (ajuste la versión a la de su |Fess|)
