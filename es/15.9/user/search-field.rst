=================================================
Búsqueda por campo (acotar por título, URL y más)
=================================================
...
.. tip::
    Si desea buscar por una parte de la URL, puede usar ``inurl:`` para realizar una búsqueda de coincidencia parcial sobre la URL. Por ejemplo, ``inurl:15.9`` busca documentos cuya URL contenga ``15.9``.
