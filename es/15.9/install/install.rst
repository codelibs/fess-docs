...
Versión de Paquetes Linux (ZIP/RPM/DEB)
-------------------------------------------
...
**Entorno Recomendado:** Entorno de producción (se recomienda RPM/DEB para gestión como servicio del sistema), entornos que requieren personalización
...
3. **Configuración de OpenSearch**
   ...
   - Instalación de OpenSearch 3.8.0
...
Para las versiones ZIP/RPM/DEB, se requiere Java 21 o posterior.
