...
Por defecto se guardan dentro del directorio de instalación de OpenSearch (por ejemplo, ``opensearch-3.8.0/data``),
...
Elimine los archivos de registro::
    ...
    $ rm -rf /path/to/fess-15.9.0/logs
...
Si desea eliminar las imágenes Docker para liberar espacio en disco::
    ...
    $ docker rmi ghcr.io/codelibs/fess:15.9.0
...
Versión ZIP::
    ...
    $ ls /path/to/fess-15.9.0  # Verifique que el directorio no exista
