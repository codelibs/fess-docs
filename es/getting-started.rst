...
.. warning::
   ...
   **Nota importante sobre seguridad**
   ...
   Para instrucciones sobre cómo cambiar la contraseña, consulte :doc:`15.8/admin/user-guide`.
...
- :doc:`15.8/admin/index` — Detalles sobre la configuración de rastreo y búsqueda
- :doc:`15.8/api/index` — Integración de búsqueda mediante REST API
