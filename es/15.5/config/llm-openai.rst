...
|Fess| puede utilizar la API de OpenAI para implementar la funcionalidad de chat RAG.
...
- ``gpt-4o`` - Modelo de alto rendimiento mas reciente
...
- :doc:`rag-chat` - Detalles de la funcionalidad de chat RAG
