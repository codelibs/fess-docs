...
A partir de |Fess| 15.8, la función de modo de búsqueda con IA (RAG Chat) se separó en los plugins
...
.. list-table::
   ...
   * - ``FESS_PLUGINS``
     - Plugins que se instalan automáticamente al iniciar (formato ``name:version`` separado por espacios; ejemplo: ``fess-ds-wikipedia:15.8.0``)
