...
En |Fess| 15.8, la **función de chunking de contenido** — que divide el cuerpo de los documentos
...
- **OpenSearch con el plugin k-NN**: En |Fess| 15.8, el mapeo del índice de búsqueda
...
Cualquier índice ``fess.search`` creado nuevo bajo |Fess| 15.8 siempre tiene configuración de
...
.. note::
   ...
   la reindexación) a partir de |Fess| 15.8 aplica el mapeo que contiene
...
15.7 y versiones anteriores, se ha incorporado al núcleo en la versión 15.8 y ahora es
