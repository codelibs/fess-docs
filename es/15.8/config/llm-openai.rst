...
1. Descargue `fess-llm-openai-15.8.0.jar`
...
- ``FESS_PLUGINS=fess-llm-openai:15.8.0`` hace que el ``run.sh`` del contenedor descargue e instale automaticamente el plugin en ``app/WEB-INF/plugin/``
