...
Supongamos que esta oración es dividida por el Analyzer en "Tokio", "en" y "Vivir".
En este caso, si se realiza una búsqueda con la palabra "Tokio", se obtendrán resultados.
Sin embargo, si se realiza una búsqueda con la palabra "Kio", no se obtendrán resultados.
