...
.. note::
   Cada nodo notifica únicamente los registros que él mismo ha generado (los eventos se filtran por ``hostname``).
   En una configuración en clúster, se envía una notificación individual por cada nodo.
