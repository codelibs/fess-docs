...
consulte la :doc:`Guia de instalacion con Docker <15.8/install/install-docker>`.
...
- :doc:`Guia de administracion <15.8/admin/index>` - Configuracion y gestion
- :doc:`Referencia de API <15.8/api/index>` - Integre la busqueda en sus aplicaciones
