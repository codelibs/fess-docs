...
- Java 21이 설치되어 있을 것
- OpenSearch 3.5.0를 사용 가능한 상태로 할 것(또는 신규 설치)
...
1. OpenSearch 다운로드
   ...
   .. note::
      ...
      이 예제에서는 OpenSearch 3.5.0를 사용하고 있습니다.
...
플러그인 호환성을 보장하기 위해 권장 버전(3.5.0)을 사용할 것을 강력히 권장합니다.
