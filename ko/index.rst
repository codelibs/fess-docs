...
OpenSearch(또는 Elasticsearch)를 검색 엔진으로 사용하며, 키워드 검색·패싯·역할 기반 검색을 기본으로 제공합니다. 선택적 플러그인을 통해 **시맨틱(벡터) 검색**\ , **하이브리드 검색**\ , 그리고 Ollama·OpenAI·Google Gemini 등의 LLM을 활용한 **AI 검색 모드(RAG)**\ 를 추가할 수 있습니다.
...
- :doc:`Fess 15.7.0 <downloads>` (zip/rpm/deb 패키지)
