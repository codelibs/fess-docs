...
- Java 21이 설치되어 있을 것
- OpenSearch 3.6.0를 사용 가능한 상태로 할 것(또는 신규 설치)
...
.. note::
   ...
   ``C:\opensearch-3.6.0\data\config\`` 가 아니라 ``C:/opensearch-3.6.0/data/config/`` 로 기술합니다.
...
예::
    ...
    C:\opensearch  (권장)
    C:\Program Files\opensearch-3.6.0  (비권장 - 경로가 김)
