=========================================
데이터 저장소 크롤링(데이터베이스 검색)
=========================================

개요
====

데이터 저장소 크롤링은 관계형 데이터베이스(MySQL・PostgreSQL・Oracle 등)나 CSV 파일과 같이 웹사이트나 파일이 아닌 데이터 소스를 |Fess| 의 인덱스에 등록하여 전문 검색할 수 있도록 하는 기능입니다. 데이터베이스 검색을 구현하고자 할 때 이 기능을 사용합니다.
