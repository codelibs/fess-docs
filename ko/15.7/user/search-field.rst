...
특정 필드만을 대상으로 하는 검색(필드 검색)을 하면 제목만, URL만과 같이 범위를 좁힌 검색을 할 수 있습니다. |Fess| 에서 크롤링한 결과는 제목이나 본문 등 각 필드별로 저장됩니다. 이러한 필드를 지정하여 검색할 수 있습니다. 필드를 지정하여 검색하면 문서 유형별 또는 크기별 등 세밀한 검색 조건을 지정할 수 있습니다.
