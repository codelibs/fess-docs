...
siehe die :doc:`Docker-Installationsanleitung <15.8/install/install-docker>`.
...
- :doc:`Admin-Handbuch <15.8/admin/index>` - Konfiguration und Verwaltung
- :doc:`API-Referenz <15.8/api/index>` - Integration der Suche in Ihre Anwendungen
