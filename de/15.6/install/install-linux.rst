...
- OpenSearch 3.6.0 ist verfügbar (oder wird neu installiert)
...
1. Download von OpenSearch
   ...
   .. note::
      ...
      In diesem Beispiel wird OpenSearch 3.6.0 verwendet.
...
2. Installation der OpenSearch-Plugins
   ...
   .. important::
      ...
      Im obigen Beispiel sind alle auf 3.6.0 gesetzt.
...
Um die Plugin-Kompatibilität zu gewährleisten, wird die Verwendung der empfohlenen Version (3.6.0) dringend empfohlen.
