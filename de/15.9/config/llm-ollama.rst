...
1. Laden Sie `fess-llm-ollama-15.9.0.jar` herunter.
...
- ``FESS_PLUGINS=fess-llm-ollama:15.9.0`` bewirkt, dass das Startskript die Plugin-JAR automatisch herunterlädt und in ``app/WEB-INF/plugin/`` ablegt (passen Sie die Version an Ihre |Fess|-Version an)
