...
.. note::
   Ab |Fess| 15.9 wird die Autorisierungsantwort in Schritt 4 als GET-Anfrage zurückgegeben, da
...
.. note::
   ...
   Ab 15.9 wird zusätzlich ``openid profile offline_access https://graph.microsoft.com/.default`` an den Autorisierungsendpunkt gesendet, sodass die Zustimmung für denselben Umfang eingeholt wird.
