...
1. Laden Sie `fess-llm-gemini-15.9.0.jar` herunter
...
- ``FESS_PLUGINS=fess-llm-gemini:15.9.0`` lässt das ``run.sh`` des Containers das Plugin automatisch herunterladen und in ``app/WEB-INF/plugin/`` installieren
