...
Für die manuelle Installation legen Sie die entsprechende JAR-Datei (Beispiel: ``fess-llm-openai-15.9.0.jar`` für den OpenAI-Anbieter) im folgenden Verzeichnis ab.
