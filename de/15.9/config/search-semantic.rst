...
In |Fess| 15.9 wurde die **Content-Chunking-Funktion** — die Dokumentinhalte in Chunks aufteilt
...
- **OpenSearch mit dem k-NN-Plugin**: In |Fess| 15.9 enthält das Mapping des Suchindex
...
Jeder unter |Fess| 15.9 neu erstellte ``fess.search``-Index hat immer ``index.knn``- und
...
.. note::
   ...
   Auch wenn Sie die Vektorsuche nicht nutzen: Sobald ab |Fess| 15.9 ein Index **neu erstellt**
...
bereitstellte, wurde in 15.9 in den Kern integriert und ist nun **unnötig (veraltet)**.
