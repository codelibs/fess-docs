...
Linux-Paketversion (ZIP/RPM/DEB)
-----------------------------------
...
3. **Einrichtung von OpenSearch**
   ...
   - Installation von OpenSearch 3.8.0
...
``bin/fess-setup install opensearch`` richtet OpenSearch mit diesen Plugins ein. Einzelheiten siehe :doc:`install-linux`.

Java (außer Docker-Version)
----------------------------

Für die ZIP/RPM/DEB-Version ist Java 21 oder höher erforderlich.
