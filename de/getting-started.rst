...
.. warning::
   ...
   **Wichtiger Sicherheitshinweis**
   ...
   Anleitungen zur Passwortänderung finden Sie unter :doc:`15.8/admin/user-guide`.
...
- :doc:`15.8/admin/index` — Details zu Crawl-Einstellungen und Sucheinstellungen
- :doc:`15.8/api/index` — Integration der Suche über REST-API
