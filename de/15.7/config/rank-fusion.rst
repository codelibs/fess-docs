...
Um die semantische Suche zu aktivieren, installieren Sie das Semantic Search-Plugin (``fess-webapp-semantic-search``) und fügen Sie ``semantic`` zu ``-Drank.fusion.searchers`` hinzu.
