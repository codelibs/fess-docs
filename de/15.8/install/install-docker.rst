...
Seit |Fess| 15.8 wurde die Funktion des AI-Suchmodus (RAG Chat) als ``fess-llm-*``-Plugins ausgelagert.
...
.. list-table::
   ...
   * - ``FESS_PLUGINS``
     - Beim Start automatisch zu installierende Plugins (durch Leerzeichen getrenntes Format ``name:version``. Beispiel: ``fess-ds-wikipedia:15.8.0``)
