...
`https://github.com/codelibs/docker-fess/compose <https://github.com/codelibs/docker-fess/tree/v15.0.0/compose>`__ から以下のファイルを取得します。

- `compose.yaml <https://raw.githubusercontent.com/codelibs/docker-fess/v15.0.0/compose/compose.yaml>`__
- `compose-opensearch2.yaml <https://raw.githubusercontent.com/codelibs/docker-fess/v15.0.0/compose/compose-opensearch2.yaml>`__
