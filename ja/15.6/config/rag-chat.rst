...
AIモード（RAG: Retrieval-Augmented Generation）は、|Fess| の検索結果をLLM（大規模言語モデル）で拡張し、
...
|Fess| のWebインターフェースでは、検索画面からAIモード機能を利用できます。
