...
|Fess| のシステムプロパティを設定します。
``key=value`` の形式で1行ずつ指定します。
...
IdP（Identity Provider）のエンティティIDを指定します。

IdP SSO URL
:::::::::::

IdPのシングルサインオンサービスURLを指定します。

IdP SLO URL
:::::::::::

IdPのシングルログアウトサービスURLを指定します。

IdP X.509証明書
:::::::::::::

IdPのSAMLアサーション署名検証に使用するX.509公開鍵証明書を指定します。
``-----BEGIN CERTIFICATE-----`` および ``-----END CERTIFICATE-----`` の行を含まず、Base64エンコードされた内容のみを指定します。
...
SP（Service Provider）のエンティティIDを指定します。
``SPベースURL`` を設定している場合は自動的に設定されます。

SP ACS URL
::::::::::

SAMLアサーションを受信するAssertion Consumer Service（ACS）のURLを指定します。
``SPベースURL`` を設定している場合は自動的に設定されます。

SP SLO URL
::::::::::

SPのシングルログアウトサービスURLを指定します。
``SPベースURL`` を設定している場合は自動的に設定されます。

SP NameIDフォーマット
:::::::::::::::::::

SAMLアサーションで使用するNameIDのフォーマットを指定します。
...
Microsoft Entra IDのテナントIDまたはドメインを指定します。
...
.. |image0| image:: ../../../resources/images/ja/15.6/admin/general-1.png
.. |image1| image:: ../../../resources/images/ja/15.6/admin/general-2.png
.. |image2| image:: ../../../resources/images/ja/15.6/admin/general-3.png
.. |image3| image:: ../../../resources/images/ja/15.6/admin/general-4.png
.. |image4| image:: ../../../resources/images/ja/15.6/admin/general-5.png
.. |image5| image:: ../../../resources/images/ja/15.6/admin/general-6.png
.. |image6| image:: ../../../resources/images/ja/15.6/admin/general-7.png
.. |image7| image:: ../../../resources/images/ja/15.6/admin/general-8.png
.. pdf            :height: 940 px