...
- :doc:`Fess 13.7.0 <downloads>` (zip/rpm/debパッケージ)
...
2020-02-15
    `Fess 13.6.0 <https://github.com/codelibs/fess/releases/tag/fess-13.6.0>`__ リリース

2020-01-26
    `Fess 13.5.1 <https://github.com/codelibs/fess/releases/tag/fess-13.5.1>`__ リリース
