...
- :doc:`Fess 12.4.1 <downloads>` (zip/rpm/debパッケージ)
...
2018-12-16
    `Fess 12.4.1 <https://github.com/codelibs/fess/releases/tag/fess-12.4.1>`__ リリース

2018-12-16
    `Fess 12.3.4 <https://github.com/codelibs/fess/releases/tag/fess-12.3.4>`__ リリース
