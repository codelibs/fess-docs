...
|Fess| はユーザー管理機能を提供しており、ユーザーがログインすることでロール検索を利用することができます。|Fess| で管理するユーザーはログイン後、ロール検索やユーザーのパスワードを変更することができます。
...
.. |image0| image:: ../../../resources/images/ja/15.4/user/role-search-1.png
.. pdf   :width: 200 px
.. |image1| image:: ../../../resources/images/ja/15.4/user/role-search-2.png
.. pdf   :width: 300 px
