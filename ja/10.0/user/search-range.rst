...
+-------------------------------------------------------+------------------------------------------------------------------+
| YYYY-MM-DDThh:mm:ss.sZ（例：2013-08-02T10:45:23.5Z)   | now(現在の日時)、y(年)、M(月)、w(週)、d(日)、h(時)、m(分)、s(秒) |
+-------------------------------------------------------+------------------------------------------------------------------+
...
::
    ...
    last_modified:[now-30d TO now](=[2016-01-23T00:00:00Z+TO+2016-02-21T20:00:00Z(現在日時)])
