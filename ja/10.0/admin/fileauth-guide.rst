...
.. 概要、設定項目
ここでは、ファイルを対象としたクロールに対してファイル認証が必要な場合の設定方法について説明します。 Fess は FTP または Windows の共有フォルダに対する認証に対応しています。
...
.. Fess9:認証方法を選択します。 FTP または SAMBA (Windows共有フォルダ認証) を利用することができます。
TBD
