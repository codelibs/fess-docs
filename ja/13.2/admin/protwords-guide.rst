...
下図のProtwordsの設定一覧ページを開くには、左メニューの [システム > 辞書] を選択した後、en/protwords.txtをクリックします。
...
.. |image0| image:: ../../../resources/images/ja/13.2/admin/protwords-1.png
.. |image1| image:: ../../../resources/images/ja/13.2/admin/protwords-2.png
