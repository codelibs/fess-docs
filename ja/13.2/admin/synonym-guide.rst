...
下図の同義語の設定一覧ページを開くには、左メニューの [システム > 辞書] を選択した後、synonym.txtをクリックします。
...
.. |image0| image:: ../../../resources/images/ja/13.2/admin/synonym-1.png
.. |image1| image:: ../../../resources/images/ja/13.2/admin/synonym-2.png
