...
しきい値を超える障害URLはクロール対象から除外されますが、ここで指定された例外名などはしきい値を超える障害URLでもクロール対象になり>ます。
...
+----------------------------+---------------------------------------------+---------------------------------------------+
| Bind DN                    | uid=%s,ou=People,dc=fess,dc=codelibs,dc=org | manager@fess.codelibs.org (Windows2000以降) |
+----------------------------+---------------------------------------------+---------------------------------------------+
| User DN                    | uid=%s,ou=People,dc=fess,dc=codelibs,dc=org | %s@fess.codelibs.org (Windows2000以降)      |
+----------------------------+---------------------------------------------+---------------------------------------------+
...
.. |image0| image:: ../../../resources/images/ja/10.3/admin/general-1.png
