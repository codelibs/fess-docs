...
管理画面の ［システム］ > ［辞書］ から Kuromoji 辞書を選択して設定できます。
...
特定の語の語幹変換を上書きします。
管理画面の ［システム］ > ［辞書］ から Stemmer上書き辞書を選択して設定できます。
...
中国語のドキュメントには、Fess 独自の中国語トークナイザーが使用されます。
Fess の多言語インデックスでは、簡体字・繁体字いずれの中国語テキストも適切にトークナイズされます。
