...
1. `fess-llm-ollama-15.8.0.jar` をダウンロードします。
...
- ``FESS_PLUGINS=fess-llm-ollama:15.8.0`` で起動スクリプトがプラグイン JAR を自動取得して ``app/WEB-INF/plugin/`` に配置します（バージョンはお使いの |Fess| に合わせてください）
