...
OpenSearch 2.13.0をインストール場合を説明します。
...
OpenSearchのプラグインはOpenSearchのバージョンに合わせる必要があります。
OpenSearch 2.13.0をインストールする場合を説明します。
...
`https://github.com/codelibs/docker-fess/compose <https://github.com/codelibs/docker-fess/tree/v14.13.0/compose>`__ から以下のファイルを取得します。
