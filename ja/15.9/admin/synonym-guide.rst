...
同義語とは、表記は異なるが意味が同じ(または近い)単語のことです。
たとえば「GB」と「ギガバイト」、「PC」と「パソコン」、「テレビ」と「TV」などが同義語(類義語)にあたります。
Fess の同義語辞書に登録しておくと、いずれか一方の単語で検索したときに、
同義語として登録した他の単語を含むドキュメントも検索結果に含められます。
これにより、表記ゆれによる検索漏れを防ぎ、検索のヒット率を高めることができます。
...
.. note::
   ...
   同義語を登録・変更しても、そのままでは検索結果に反映されません。
   :ref:`dict-apply-changes` の手順でドキュメントインデックスをリロードしてください。
...
.. |image0| image:: ../../../resources/images/ja/15.9/admin/synonym-1.png
.. |image1| image:: ../../../resources/images/ja/15.9/admin/synonym-2.png
