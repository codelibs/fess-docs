...
パスワードで保護されているRedmine(例. https://<server>/)のウェブクロールは、下記のようにウェブクロールの設定の作成を行います。
...
XWiki(例. https://<server>/xwiki/)のウェブクロールは、下記のようにウェブクロールの設定の作成を行います。
