...
- OpenSearch 3.6.0 を利用可能な状態にすること（または新規インストール）
...
.. note::
   ...
   ``C:\opensearch-3.6.0\data\config\`` ではなく ``C:/opensearch-3.6.0/data/config/`` と記述します。
...
例::
    ...
    C:\opensearch  (推奨)
    C:\Program Files\opensearch-3.6.0  (非推奨 - パスが長い)
