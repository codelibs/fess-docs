...
::
   ...
   1. url:https\:\/\/fess.codelibs.org\/ja\/12.3\/*
   2. url:"https://fess.codelibs.org/ja/12.3/*"

1はワイルドカードクエリーが使えますので、 ``url:*\/\/fess.codelibs.org\/*`` のような書き方もできます。
url中にある「:」や「/」は予約語ですのでエスケープしてあげてください。
2はワイルドカードは使えませんが、プレフィックスクエリーが使えます。
