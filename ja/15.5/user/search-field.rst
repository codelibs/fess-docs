...
HTMLファイルを検索対象としている場合、title タグが title フィールド、body タグ以下の文字列が content フィールドに登録されています。
...
title フィールドに対して、fess を検索語として検索する場合は以下のように入力します。
...
url フィールドに対して検索する場合は以下のように入力します。
