...
|Fess| のランクフュージョン機能は、複数の検索結果を統合して
より精度の高い検索結果を提供します。

ランクフュージョンとは
======================

ランクフュージョンは、複数の検索アルゴリズムやスコアリング手法の結果を
...
|Fess| では以下のランクフュージョンアルゴリズムをサポートしています：
...
ランクフュージョンは、キーワード検索とセマンティック検索を組み合わせた
ハイブリッド検索で特に効果を発揮します。
